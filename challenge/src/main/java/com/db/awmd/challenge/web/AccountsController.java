...
public class AccountsController {
  ...
  @PostMapping(path = "/transfer", consumes = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<Object> transfer(@RequestBody @Valid TransferAmount TransferAmount) {
		log.info("Transffering amount  {}", TransferAmount);
		try {
			this.accountsService.tranfer(TransferAmount);
		} catch (DuplicateAccountIdException daie) {
